...
impl Secp256k1 {
    ...
    pub fn new(x: FieldElement, y: FieldElement) -> Secp256k1 {
        ...
        let point = Point::new(x, y, a, b);
        Secp256k1 { prime, generator, point }
    }
    ...
    pub fn verify(&self, z: FieldElement, signature: Signature) -> bool {
        ...
        // u * G + v * P
        let total = self.generator.multiply(&u).add(&Secp256k1::new(signature.r.clone(), signature.s).point.multiply(&v));
