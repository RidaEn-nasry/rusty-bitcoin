...
use crate::crypto::{ecdsa, get_rndm, signature, FieldElement, encodebase58check::*};
...
fn main() {
    ...
    */
    ...
    println!("{}", encode_base58check(&keys.sec_comp()));
    // let sec_base58 = encode_base58check(&keys.sec_comp());
    // let hashed_sec = hash_str(sec_base58.as_str());
    // let hashed_sec = hash_ripemd(hashed_sec.as_str());
    // let final_hash = encode_base58check(&hashed_sec);
    // println!("hashed sec: {}", hashed_sec);
